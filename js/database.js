...
window.courses = [
    ...
    [
        { name: "Int. à Eng. Controle e Automação", credits: 2, code: "COE100", semester: 1, category: 1, workload: 30},
        { name: "Algoritmos e Programação", credits: 5, code: "COS110", semester: 1, category: 1, workload: 90},
        { name: "Lógica Matemática", credits: 5, code: "COS230", semester: 1, workload: 90},
        ...
        { name: "Sistemas Projetivos", credits: 5, code: "EEG105", semester: 2, workload: 90},
        { name: "Circuitos Lógicos", credits: 5, code: "EEL280", semester: 2, workload: 90},
        { name: "Linguagens de Programação", credits: 5, code: "EEL670", semester: 2, category: 1, workload: 90},
        { name: "Física Experimental II", credits: 1, code: "FIS121", semester: 2, requirements: [3, 4], category: 1, workload: 30},
        { name: "Física II", credits: 4, code: "FIT122", semester: 2, requirements: [4, 6], category: 1, workload: 60},
        { name: "Cálculo II", credits: 4, code: "MAC128", semester: 2, requirements: [6], category: 1, workload: 60},
        
        { name: "Mecânica I", credits: 5, code: "EEA212", semester: 3, requirements: [12], category: 1, workload: 75},
        { name: "Mét. Mat. em Eng. Eletrônica", credits: 4, code: "EEI356", semester: 3, requirements: [12], category: 1, workload: 60},
        { name: "Física III", credits: 4, code: "FIM230", semester: 3, requirements: [12], category: 1, workload: 60},
        { name: "Física Experimental III", credits: 1, code: "FIN231", semester: 3, requirements: [10], category: 1, workload: 30},
        { name: "Cálculo III", credits: 4, code: "MAC238", semester: 3, requirements: [12], category: 1, workload: 60},
        { name: "Álgebra Linear II", credits: 4, code: "MAE125", semester: 3, category: 1, workload: 60},
        { name: "Atividades Acad. Opt. (Grupo 1)", credits: 2, semester: 3, category: 4, workload: 30},

        { name: "Estatística e Mod. Probabilísticos", credits: 4, code: "COE241", semester: 4, category: 1, workload: 60},
        { name: "Sinais e Sistemas", credits: 4, code: "COE350", semester: 4, category: 1, workload: 60},
        { name: "Circuitos Elétricos em CC", credits: 4, code: "EEE321", semester: 4, requirements: [12, 15], category: 1, workload: 60},
        { name: "Sistemas Digitais", credits: 5, code: "EEL480", semester: 4, requirements: [8], category: 1, workload: 90},
        { name: "Física IV", credits: 4, code: "FIM240", semester: 4, requirements: [15], category: 1, workload: 60},
        { name: "Física Experimental IV", credits: 1, code: "FIN241", semester: 4, requirements: [16], category: 1, workload: 30},
        
        /* Continuar a partir de Modelagem: Depois tentar pegar os créditos de cada disciplina */
        { name: "Matemática Computacional", credits: 4, code: "COC351", requirements: [6, 18], semester: 5, category: 1, workload: 75},
        { name: "Modelagem de Sistemas Dinâmicos", credits: 4, code: "COE240", semester: 5, category: 1, workload: 60},
        { name: "Processos de Fabricação", credits: 4, code: "COM352", semester: 5, requirements: [7, 16], category: 1, workload: 60},
        { name: "Lab. Circuitos Elétricos I", credits: 5, code: "EEE322", semester: 5, category: 1, workload: 75},
        { name: "Engenharia e Meio Ambiente", credits: 2, code: "EEH210", semester: 5, category: 1, workload: 60},
        { name: "Eletrônica I", credits: 2, code: "EEL338", semester: 5, category: 1, workload: 60},
        
        { name: "Controle Realimentado", credits: 4, semester: 6, code: "COE360", requirements: [0, ,7, 16], category: 1, workload: 60},
        { name: "Introdução à Otimização", credits: 4, semester: 6, code: "COM361", requirements: [0, ,7, 16], category: 1, workload: 60},
        { name: "Lab. Eletrônica I", credits: 4, code: "EEL339", semester: 6, category: 1, workload: 60},
        { name: "Eletrônica II", credits: 4, code: "EEL438", semester: 6, category: 1, workload: 75},
        { name: "Redes de Computadores I", credits: 4, code: "EEL878", semester: 6, category: 1, workload: 75},
        { name: "Controle e Inst. de Processos", credits: 4, code: "EQE487", semester: 6, category: 1, workload: 60},

        { name: "Controle Avançado", credits: 4, code: "COE470", semester: 7, requirements: [13, 6], category: 1, workload: 75},
        { name: "Sensores e Atuadores I", credits: 3, code: "COE471", semester: 7, category: 1, workload: 75},
        { name: "Planej. de Proc. e Fabric. Ind.", credits: 4, code: "COP473", semester: 7, category: 1, workload: 60},
        { name: "Automação Industrial", credits: 4, code: "EEE643", semester: 7, category: 1, workload: 60},
        { name: "Lab. Eletrônica II", credits: 4, code: "EEL439", semester: 7, category: 1, workload: 75},
        { name: "Processamento de Sinais", credits: 4, code: "EEL711", semester: 7, category: 1, workload: 75},
        { name: "Planej. e Aval. de Projetos", credits: 8, code: "EQE486", semester: 7, step: 1, category: 2, workload: 120},

        { name: "Controle em Tempo Real", credits: 4, code: "COE480", semester: 8, requirements: [26], category: 1, workload: 60},
        { name: "Sensores e Atuadores II", credits: 4, code: "COE481", semester: 8, category: 1, workload: 60},
        { name: "Lab. de Automação e Controle", credits: 4, code: "COE482", semester: 8, requirements: [34], category: 1, workload: 60},
        { name: "Robótica e Automação", credits: 4, code: "EEL855", semester: 8, requirements: [34], category: 1, workload: 60},
        { name: "Sist. de Controle Não Lineares", credits: 4, code: "EEL856", semester: 8, requirements: [34], category: 1, workload: 60},
        { name: "Inst. Automação Ind. de Processo", credits: 4, code: "EQE026", semester: 8, requirements: [34], category: 1, workload: 60},
        { name: "Engenharia de Processos", credits: 4, code: "EQ3489", semester: 8, requirements: [34], category: 1, workload: 60},
        
        { name: "Economia", credits: 4, code: "EEI312", semester:9, requirements: [34], category: 1, workload: 60},
        { name: "Estágio Obrigatório", credits: 160, code: "EEWU00", semester: 9, category: 1, workload: 160},
        { name: "Projeto de Graduação", credits: 4, code: "EEWX00", semester: 9, category: 1, workload: 180},
        ...
        { name: "Organização das Indústrias", credits: 4, code: "EEI321", semester:10, requirements: [34], category: 1, workload: 60},
